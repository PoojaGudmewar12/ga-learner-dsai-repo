...
print("Sample Message is: ",sample_message)
...
print("Message_1 is: ", message_1 +"\n Message_2 is: "+message_2)

#Calling the function 'fuse_msg'
secret_msg_1=fuse_msg(message_1,message_2)
print("secret_msg_1 - output of fuse_msg is: ", secret_msg_1)
...
#Printing the secret message
print("secret_msg_2 after substitute function is: "+secret_msg_2)
...
#Printing the secret message
print("secret_msg_3 after comparing files is: ",secret_msg_3)
...
#Printing the secret message
print("secret_msg_4 having even length words is : ",secret_msg_4)

#Secret message parts in the correct order
message_parts=[secret_msg_3, str(secret_msg_1), secret_msg_4, secret_msg_2]
print("message_parts in correct sequence is: ",message_parts)
...
print("secret_msg is: ",secret_msg)
...
append_to_file=write_file(secret_msg,final_path)

#Printing the entire secret message
print("The final entire secret message is: ",secret_msg)
